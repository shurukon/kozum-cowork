...
export function makeFakeBridge(
  ...
  const providers: KozumBridge["providers"] = {
    ...
    addCustom: async (input) => ({ ok: true, value: { id: "custom-1", name: input.name, protocol: "openai-chat", baseUrl: input.baseUrl, authScheme: "bearer", modelsPath: "/models", staticModels: [input.modelId], builtIn: false } }),
    addModel: async (_pid, modelId) => ({ ok: true, value: { id: "custom-1", name: "Custom", protocol: "openai-chat", baseUrl: "https://x", authScheme: "bearer", modelsPath: "/models", staticModels: [modelId], builtIn: false } }),
    removeModel: async (_pid, _modelId) => ({ ok: true, value: { id: "custom-1", name: "Custom", protocol: "openai-chat", baseUrl: "https://x", authScheme: "bearer", modelsPath: "/models", staticModels: [], builtIn: false } }),
