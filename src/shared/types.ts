...
export type AgentEvent =
  | { type: "turn_start"; sessionId: string; messageId: string; model: string }
  ...
  | { type: "tool_progress"; sessionId: string; toolUseId: string; note: string }
  | { type: "tool_end"; sessionId: string; toolUseId: string; result: ToolResult }
  | {
  ...
  | { type: "turn_end"; sessionId: string; messageId: string; usage: TokenUsage; stopReason: StopReason }
  | { type: "error"; sessionId: string; message: string; recoverable: boolean }
  | { type: "session_status"; sessionId: string; status: SessionStatus }
  | { type: "task_update"; sessionId: string; tasks: AgentTask[] };
